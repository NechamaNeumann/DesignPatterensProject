...
#region FinalProject
Console.WriteLine("---------FinalProject---------");
...
Branch branch1 = new Branch("FileSystem1","main",itemsState1,list1);
...
Folder1.Backup(Folder1.Name);
Folder1.Backup(Folder1.Name);
Folder1.ShowHistory();
File1.State.Commited(File1);
File1.State.RequstReview();
